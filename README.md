## Precise Information Control in Long-Form Generation
...
This repository contains the code and data for our 2025 preprint: [Precise Information Control in Long-Form Generation]().

![Overview of PIC](figures/teaser.png)
